<%@ Page Title="" Language="C#" MasterPageFile="~/Console/Main.Master" AutoEventWireup="true"
    CodeBehind="SiteReport.aspx.cs" Inherits="CSI.WebUI.Console.Dashboard.Reports.SiteReport" %>
...
<asp:Content ID="cntSite" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#tblElectricityEvolution').dataTable({
                "bPaginate": true,
                "bLengthChange": true,
                "bFilter": true,
                "bSort": false,
            ...
            $('#tblElectricityMeters').dataTable({
                "bPaginate": true,
                "bLengthChange": true,
                "bFilter": true,
                "bSort": false,
            ...
            $('#tblTransportEvolution').dataTable({
                "bPaginate": true,
                "bLengthChange": true,
                "bFilter": true,
                "bSort": false,
    ...
    <script type="text/javascript">
        ...
        function validateFilter(source, args) {
            ...
            var _txt = $get('<%=txtFrom.ClientID%>').value;
            if (_txt != '') {
                $get('<%=hdnFrom.ClientID%>').value = _txt;
            }

            _txt = $get('<%=txtTo.ClientID%>').value;
            if (_txt != '') {
                $get('<%=hdnTo.ClientID%>').value = _txt;
            }
   ...
   <style>
        #divLeftPane #divMenu .lnkSite {display:none;}
   </style>
    ...
    <div class="divDetail">
        ...
        <asp:Label runat="server" ID="lblWaterMeters"></asp:Label><br />
            ...
            <!--*************** EF Specs ********************** -->
            <!--*********************************************** -->
            <asp:Label ID="lblEFData" runat="server"></asp:Label><br />
            <asp:LinkButton ID="lnkEFs" runat="server"></asp:LinkButton>
            <br />
        </div>
    </div>
</asp:Content>
