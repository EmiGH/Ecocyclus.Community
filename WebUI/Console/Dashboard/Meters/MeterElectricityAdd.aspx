<%@ Page Language="C#" MasterPageFile="~/Console/Main.Master" AutoEventWireup="true"
    CodeBehind="MeterElectricityAdd.aspx.cs" Inherits="CSI.WebUI.Console.Dashboard.Meters.MeterElectricityAdd" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>


<asp:Content ID="cntMeterElectricityAdd" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function toggleDescriptionTranslations() {
            ...
            $('#divDescriptionTranslations').toggle();
        }
        ...
        function toggleEFDescriptionTranslations() {
            ...
            $('#divEFDescriptionTranslations').toggle();
        }
    ...
    <script type="text/javascript">
        ...
        //******************************************
        //      EF Selector Functions & Validation
        //******************************************

        function toggleEFSelector() {

            $('#divEFSelector').toggle();
        }
        ...
        function toggleInitialReading() {
            $('#divInitialReading').toggle();
        }

        function validateInitialReading(source, arguments) {

            if ($('#<%=chkIsPhysical.ClientID%>').is(':checked')) {
    ...
    <div class="divForm AddMeter">
        ...
        <div class="divColumn column3">
            ...
            <asp:CompareValidator ID="cvFrequencyQuantity" runat="server" ControlToValidate="txtFrequencyQuantity"
                Type="Integer" Operator="DataTypeCheck" ValidationGroup="Add" CssClass="rfvRequested"
                Display="Dynamic"></asp:CompareValidator>
            <asp:RequiredFieldValidator ID="rfvFrequencyQuantity" runat="server" ControlToValidate="txtFrequencyQuantity"
                ValidationGroup="Add" CssClass="rfvRequested" Display="Dynamic"></asp:RequiredFieldValidator>
        ...
        <div class="divColumn column3 last">
            ...
            <asp:CompareValidator ID="cvFrequencyUnits" runat="server" ControlToValidate="ddlFrequencyUnits"
                Operator="NotEqual" ValueToCompare="0" ValidationGroup="Add" CssClass="rfvRequested"
                Display="Dynamic"></asp:CompareValidator>
        ...
        <div class="divColumn column3">
            ...
            <asp:RangeValidator ID="rvAlertBefore" runat="server" ValidationGroup="Add" Type="Integer"
        ...
        <div class="divColumn column3">
            ...
            <asp:RangeValidator ID="rvAlertAfter" runat="server" ValidationGroup="Add" Type="Integer"
        ...
        <div class="divColumn column3 margin">
            ...
            <asp:CheckBox ID="chkIsPhysical" runat="server" />
        </div>
        <div id="divInitialReading" style="display: none">
            <div class="divColumn column3 margin">
                ...
                <asp:CustomValidator ID="cvInitialDate" runat="server" ValidationGroup="Add" EnableClientScript="true"
            ...
            <div class="divColumn column3 last margin">
                ...
                <asp:CustomValidator ID="cvInitialReading" runat="server" ControlToValidate="txtInitialReading"
                    ClientValidationFunction="validateInitialReading" ValidationGroup="Add"></asp:CustomValidator>
            </div>
        </div>
        <div class="divColumn column3" style="display: none;">
            ...
            <div id="divEF" style="display: none;">
                ...
                <asp:CompareValidator ID="cvEF" runat="server" ControlToValidate="txtEF" Type="Double"
                    Operator="DataTypeCheck" ValidationGroup="Add"></asp:CompareValidator>
            </div>
        </div>
        <div class="divColumn column3" style="display: none;">
            <!-- EF Selector -->
        ...
        <div class="divContentSave">
            <asp:Button ID="btnSave" runat="server" CausesValidation="true" ValidationGroup="Add"
