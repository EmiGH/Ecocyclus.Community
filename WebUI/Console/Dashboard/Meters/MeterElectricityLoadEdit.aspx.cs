...
{
    public partial class MeterElectricityLoadEdit : BasePage
    {
        private Library.Objects.Sites.Meters.ElectricityMeter _Meter;
        private Library.Objects.Sites.Meters.Series.ElectricityLoad _Load;

        protected void Page_Init(object sender, EventArgs e)
        {
            _Meter = I.GetElectricityMeter(Convert.ToInt64(Request.QueryString["Meter"]));
        ...
        private void SetMenu()
        {
            ...
            ((Main)Page.Master).MenuNavigation.Initialize(_site.IdSite, _site.Title, _Meter.IdMeter, _Meter.Identification, Console.Controls.ucMenuNavigation.MeterType.Electricity, Console.Controls.ucMenuNavigation.MenuItem.None, WebUI.Common.GetPermissionFromContext(I,_site));
        ...
        private void LoadTexts()
        {
            ...
            lblLoadEdit.Text = Resources.Data.LoadGrid;

            lblLoadFrom.Text = Resources.Data.From +_helpPostfix;
            lblLoadTo.Text = Resources.Data.To + _helpPostfix;
            lblLoadUnit.Text = Resources.Data.Unit + _mandatoryField + _helpPostfix;
            lblLoadLastOperator.Text = Resources.Data.Operator + _helpPostfix;
