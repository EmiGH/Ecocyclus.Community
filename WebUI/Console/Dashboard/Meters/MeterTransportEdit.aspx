<%@ Page Title="" Language="C#" MasterPageFile="~/Console/Main.Master" AutoEventWireup="true"
    CodeBehind="MeterTransportEdit.aspx.cs" Inherits="CSI.WebUI.Console.Dashboard.Meters.MeterTransportEdit" %>

<asp:Content ID="cntMeterTransportEdit" ContentPlaceHolderID="cphContent" runat="server">
