...
{
    public partial class MeterWaterAdd : BasePage
    {
        ...
        private void LoadUnits()
        {
            ...
            {
                ddlUnits.Items.Add(new ListItem(_unit.Name, _unit.IdUnit.ToString()));
            }
        }
        ...
        private void SaveData()
        {
            if (Page.IsValid)
            {
                try
                {
                    Library.Objects.Sites.Meters.WaterMeter _meter;
