...
{
    public partial class MeterWasteLoads : BasePage
    {
        ...
        {
            hplPrint.Attributes.Add("onclick", "window.open('" + WebUI.Common.GetPath(WebUI.Common.eFolders.Reports, Request) + "MeterWasteReportPrintable.aspx?Meter=" + _Meter.IdMeter.ToString() + "', '_blank');return false;");
        ...
        private void SetMenu()
        {
            ...
            ((Main)Page.Master).MenuNavigation.Initialize(_site.IdSite, _site.Title, _Meter.IdMeter, _Meter.Identification, Console.Controls.ucMenuNavigation.MeterType.Waste, Console.Controls.ucMenuNavigation.MenuItem.MeterSeries, WebUI.Common.GetPermissionFromContext(I,_site));
        }
        private void LoadTexts()
        {
            ...
            lblHeaderWaste.Text = Resources.Data.WasteType;
        ...
        void rptLoadSeries_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                Library.Objects.Sites.Meters.Series.WasteSerie _meterSerie = (Library.Objects.Sites.Meters.Series.WasteSerie)e.Item.DataItem;
                ...
                _lbl = ((Label)e.Item.FindControl("lblWaste"));
                _lbl.Text = _meterSerie.WasteType.Name;

                _lbl = ((Label)e.Item.FindControl("lblUnit"));
                _lbl.Text = _meterSerie.Unit.Symbol;

                _lbl = ((Label)e.Item.FindControl("lblTotal"));
                _lbl.Text = _meterSerie.Value.ToString();

                _lbl = ((Label)e.Item.FindControl("lblTotalCO2"));
                _lbl.Text = _meterSerie.TotalCO2.ToString() + " " + Resources.Data.CO2Unit;
        ...
        void rptLoadSeries_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            switch (e.CommandName)
            {
                ...
                case "Delete":
                    try
                    {
                        I.RemoveWasteData(_Meter, _Meter.GetSerie(Convert.ToInt64(e.CommandArgument)));
                    }
