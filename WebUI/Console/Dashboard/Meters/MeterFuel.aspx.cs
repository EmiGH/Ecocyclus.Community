...
{
    public partial class FuelMeter : BasePage
    {
        ...
        private void SetMenu()
        {
            ...
            ((Main)Page.Master).MenuNavigation.Initialize(_site.IdSite, _site.Title, _Meter.IdMeter, _Meter.Identification, Console.Controls.ucMenuNavigation.MeterType.Fuel, Console.Controls.ucMenuNavigation.MenuItem.Meter, WebUI.Common.GetPermissionFromContext(I,_site));
            ...
            if (I is UserOperatorMeManager || _permission == Library.Security.Authority.PermissionTypes.SiteManager)
            {
                ...
                lnkEdit.PostBackUrl = "MeterFuelEdit.aspx?Site=" + _site.IdSite.ToString() + "&Meter=" + _Meter.IdMeter.ToString();
