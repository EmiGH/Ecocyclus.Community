<%@ Page Title="" Language="C#" MasterPageFile="~/Console/Main.Master" AutoEventWireup="true"
    CodeBehind="MeterWasteLoadAdd.aspx.cs" Inherits="CSI.WebUI.Console.Dashboard.Meters.MeterWasteLoadAdd" %>
...
<asp:Content ID="cntMain" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <div class="divDetail">
        ...
        <asp:LinkButton ID="ibLoadAdd" runat="server" ValidationGroup="Load" CssClass="btnMeterAdd"></asp:LinkButton>
        <!--*******************************************************-->
        <!--****************** Loaded Values ************************-->
        <!--*******************************************************-->
        <div id="divGrid">
            ...
            <asp:UpdatePanel ID="upGrid" UpdateMode="Always" runat="server">
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="ibLoadAdd" EventName="Click" />
