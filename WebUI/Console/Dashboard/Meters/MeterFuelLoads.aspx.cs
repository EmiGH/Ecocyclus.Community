...
{
    public partial class MeterFuelLoads : BasePage
    {
        ...
        {
            hplPrint.Attributes.Add("onclick", "window.open('" + WebUI.Common.GetPath(WebUI.Common.eFolders.Reports, Request) + "MeterFuelReportPrintable.aspx?Meter=" + _Meter.IdMeter.ToString() + "', '_blank');return false;");
        ...
        private void SetMenu()
        {
            ...
            ((Main)Page.Master).MenuNavigation.Initialize(_site.IdSite, _site.Title, _Meter.IdMeter, _Meter.Identification, Console.Controls.ucMenuNavigation.MeterType.Fuel, Console.Controls.ucMenuNavigation.MenuItem.MeterSeries, WebUI.Common.GetPermissionFromContext(I,_site));
        }
        ...
        private void SetChart()
        {
            ...
            {
                _co2 = true;
                _targetValue = _target.FuelCO2;
                _targetUnit = I.CO2DefaultUnit();

            }
            else
            {
                _targetValue = _target.FuelConsumption;
                _targetUnit = _target.FuelUnit;
            }

            LoadChart(Resources.Data.ChartFuelSumMonthly, Resources.Data.Fuels, _Meter.GetSerieMonthly(), _co2, _targetValue, _targetUnit);
        ...
        void rptLoadSeries_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                case "Edit":
                    Response.Redirect(WebUI.Common.GetPath(WebUI.Common.eFolders.Meters, Request) + "MeterFuelLoadEdit.aspx?Meter=" + _Meter.IdMeter + "&Serie=" + e.CommandArgument, false);
                ...
                case "Delete":
                    try
                    {
                        I.RemoveFuelData(_Meter, _Meter.GetSerie(Convert.ToInt64(e.CommandArgument)));
                    }
