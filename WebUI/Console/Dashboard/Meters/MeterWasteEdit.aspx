<%@ Page Title="" Language="C#" MasterPageFile="~/Console/Main.Master" AutoEventWireup="true"
    CodeBehind="MeterWasteEdit.aspx.cs" Inherits="CSI.WebUI.Console.Dashboard.Meters.WasteMeterEdit" %>

<asp:Content ID="cntMeterWasteEdit" ContentPlaceHolderID="cphContent" runat="server">
