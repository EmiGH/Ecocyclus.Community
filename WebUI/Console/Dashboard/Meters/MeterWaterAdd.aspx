<%@ Page Title="" Language="C#" MasterPageFile="~/Console/Main.Master" AutoEventWireup="true"
    CodeBehind="MeterWaterAdd.aspx.cs" Inherits="CSI.WebUI.Console.Dashboard.Meters.MeterWaterAdd" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>

<asp:Content ID="cntMeterWaterAdd" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function validateInitialReading(source, arguments) {
            ...
            if ($('#<%=chkIsPhysical.ClientID%>').is(':checked')) {
                if ($.isNumeric($('#<%=txtInitialReading.ClientID%>').val())) {
    ...
    <div class="divForm AddMeter">
        ...
        <div class="divColumn column3 margin">
            <!-- Is Physical -->
            <asp:Label ID="lblIsPhysical" runat="server" CssClass="lblTitle"></asp:Label><br />
