...
{
    public partial class MeterWaterLoads : BasePage
    {
        ...
        {
            hplPrint.Attributes.Add("onclick", "window.open('" + WebUI.Common.GetPath(WebUI.Common.eFolders.Reports, Request) + "MeterWaterReportPrintable.aspx?Meter=" + _Meter.IdMeter.ToString() + "', '_blank');return false;");
        ...
        private void SetMenu()
        {
            ...
            ((Main)Page.Master).MenuNavigation.Initialize(_site.IdSite, _site.Title, _Meter.IdMeter, _Meter.Identification, Console.Controls.ucMenuNavigation.MeterType.Water, Console.Controls.ucMenuNavigation.MenuItem.MeterSeries, WebUI.Common.GetPermissionFromContext(I,_site));
        }
        private void LoadTexts()
        {
            ...
            //Printable
            hplPrint.Text = Resources.Data.PrintableVersion;
        ...
        void rptLoadSeries_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                case "Edit":
                    Response.Redirect(WebUI.Common.GetPath(WebUI.Common.eFolders.Meters, Request) + "MeterWaterLoadEdit.aspx?Meter=" + _Meter.IdMeter + "&Load=" + e.CommandArgument, false);
                ...
                case "Delete":
                    try 
                    {
                        I.RemoveWaterData(_Meter, _Meter.GetLoad(Convert.ToInt64(e.CommandArgument)));
                    }
