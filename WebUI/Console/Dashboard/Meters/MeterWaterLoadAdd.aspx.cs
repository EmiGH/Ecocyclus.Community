...
{
    public partial class MeterWaterLoadAdd : BasePage
    {
        ...
        private void SetMenu()
        {
            ...
            ((Main)Page.Master).MenuNavigation.Initialize(_site.IdSite, _site.Title, _Meter.IdMeter, _Meter.Identification, Console.Controls.ucMenuNavigation.MeterType.Water, Console.Controls.ucMenuNavigation.MenuItem.MeterLoad, WebUI.Common.GetPermissionFromContext(I,_site));
        ...
        private void LoadTexts()
        {
            ...
            lblLoadGridHeaderFrom.Text = Resources.Data.From + _mandatoryField + _helpPostfix;
            lblLoadGridHeaderTo.Text = Resources.Data.To + _mandatoryField + _helpPostfix;
            lblLoadGridHeaderUnit.Text = Resources.Data.Unit + _mandatoryField + _helpPostfix;
            if (_Meter is Library.Objects.Sites.Meters.WaterMeterPhysical)
            {
        ...
        private void LoadData()
        {
            ...
            if (_Meter.HasValue())
                ...
                if (_Meter is Library.Objects.Sites.Meters.WaterMeterPhysical)
                {
                    ...
                    _nextDate = ((Library.Objects.Sites.Meters.WaterMeterPhysical)_Meter).InitialDate.ToShortDateString();
                }
                else
        ...
        private List<Library.Objects.Sites.Meters.Series.WaterData> BuildData()
        {
            List<Library.Objects.Sites.Meters.Series.WaterData> _data = new List<Library.Objects.Sites.Meters.Series.WaterData>();
            ...
            foreach (RepeaterItem _item in rptLoadGrid.Items)
            {
                if (_item.ItemType == ListItemType.Item || _item.ItemType == ListItemType.AlternatingItem)
                {
                    ...
                    _data.Add(new Library.Objects.Sites.Meters.Series.WaterData(_from, _to, _value));
                }
            }
        ...
        void rptLoadGrid_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Header)
            {
                ...
                Label _lbl = ((Label)e.Item.FindControl("lblLoadGridHeaderFrom"));
                _lbl.Text = Resources.Data.From;

                _lbl = ((Label)e.Item.FindControl("lblLoadGridHeaderTo"));
                _lbl.Text = Resources.Data.To;

                _lbl = ((Label)e.Item.FindControl("lblLoadGridHeaderValue"));
                if (_Meter is Library.Objects.Sites.Meters.WaterMeterPhysical)
                    _lbl.Text = Resources.Data.Reading;
                else
                    _lbl.Text = Resources.Data.Value;

                _lbl = ((Label)e.Item.FindControl("lblLoadGridHeaderUnit"));
                _lbl.Text = Resources.Data.Unit;
            }
