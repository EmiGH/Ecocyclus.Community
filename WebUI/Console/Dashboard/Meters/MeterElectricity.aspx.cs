...
{
    public partial class MeterElectricity : BasePage
    {
        ...
        private void SetMenu()
        {
            ...
            ((Main)Page.Master).MenuNavigation.Initialize(_site.IdSite, _site.Title, _Meter.IdMeter, _Meter.Identification, Console.Controls.ucMenuNavigation.MeterType.Electricity, Console.Controls.ucMenuNavigation.MenuItem.Meter, WebUI.Common.GetPermissionFromContext(I,_site));
            ...
            if (I is UserOperatorMeManager || _permission == Library.Security.Authority.PermissionTypes.SiteManager)
            {
                ...
                lnkEdit.PostBackUrl = "MeterElectricityEdit.aspx?Site=" + _site.IdSite.ToString() + "&Meter=" + _Meter.IdMeter.ToString();
        ...
        private void LoadMeter()
        {
            ...
            if (_Meter is Library.Objects.Sites.Meters.ElectricityMeterPhysical)
            {
                Library.Objects.Sites.Meters.ElectricityMeterPhysical _casted = (Library.Objects.Sites.Meters.ElectricityMeterPhysical)_Meter;
        ...
        {
            I.RemoveMeterElectricity(_Meter);
