...
{
    public partial class MeterTransportEdit : BasePage
    {
        ...
        private void LoadLanguageOptions()
        {
            ...
            foreach (Library.Objects.Sites.Meters.TransportMeterLanguageOption _option in _Meter.LanguageOptions.Values)
            {
                if (_optionsString != "")
                    _optionsString += "°";
        ...
        {
            CSI.Library.Objects.Sites.Meters.TransportMeter _meter = I.GetTransportMeter(_Meter.IdMeter);
        ...
        private void SaveData()
        {
            if (Page.IsValid)
            {
                try
                {
                    ...
                    I.ModifyMeterTransport(_Meter, txtIdentification.Text, txtDescription.Text, WebUI.Common.GetTranslationStructure(hdnDescriptionTranslations.Value), _unit);
