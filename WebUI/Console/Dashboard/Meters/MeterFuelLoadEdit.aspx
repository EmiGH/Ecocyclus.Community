<%@ Page Title="" Language="C#" MasterPageFile="~/Console/Main.Master" AutoEventWireup="true"
    CodeBehind="MeterFuelLoadEdit.aspx.cs" Inherits="CSI.WebUI.Console.Dashboard.Meters.MeterFuelLoadEdit" %>
    ...
    <div class="divDetail">
        ...
        <div id="divLoad">
            ...
            <div class="divForm AddSerie">
                <div class="divColumn column5 date-input margin">
                ...
                <div class="divColumn column5 input margin" style="width: 170px !important;">
                    ...
                    <asp:CompareValidator ID="cvLoadValue" runat="server" ControlToValidate="txtLoadValue"
                        Type="Double" Operator="DataTypeCheck" ValidationGroup="Load" Display="Dynamic"
                        CssClass="rfvRequested"></asp:CompareValidator>
                    <asp:TextBox ID="txtLoadValue" runat="server" CssClass="lblValue"></asp:TextBox>
                </div>
                <div class="divColumn column5 last margin">
            ...
            <div class="divContentSave">
                <asp:Button ID="btnSave" runat="server" ValidationGroup="Load" CssClass="btnSave btnActions" />
            </div>
        </div>
    </div>
</asp:Content>
