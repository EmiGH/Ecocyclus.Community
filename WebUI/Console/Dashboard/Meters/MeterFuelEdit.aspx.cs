...
{
    public partial class FuelMeterEdit : BasePage
    {
        ...
        private void LoadLanguageOptions()
        {
            ...
            foreach (Library.Objects.Sites.Meters.FuelMeterLanguageOption _option in _Meter.LanguageOptions.Values)
            {
                if (_optionsString != "")
                    _optionsString += "°";
        ...
        {
            CSI.Library.Objects.Sites.Meters.FuelMeter _meter = I.GetFuelMeter(_Meter.IdMeter);
        ...
        private void SaveData()
        {
            if (Page.IsValid)
            {
                try
                {
                    ...
                    I.ModifyMeterFuel(_Meter, txtIdentification.Text, txtDescription.Text, WebUI.Common.GetTranslationStructure(hdnDescriptionTranslations.Value), _unit);
