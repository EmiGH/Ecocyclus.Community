<%@ Page Title="" Language="C#" MasterPageFile="~/Console/Main.Master" AutoEventWireup="true"
    CodeBehind="MeterElectricityEdit.aspx.cs" Inherits="CSI.WebUI.Console.Dashboard.Meters.MeterElectricityEdit" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>


<asp:Content ID="cntMeterElectricityEdit" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <div class="divForm AddMeter">
        ...
        <div id="divInitialReading" runat="server" style="display: none">
            ...
            <asp:TextBox ID="txtInitialDate" runat="server" ReadOnly="true"></asp:TextBox>
            ...
            <asp:Label ID="lblInitialReading" runat="server"></asp:Label><br />
            <asp:TextBox ID="txtInitialReading" runat="server"></asp:TextBox>
