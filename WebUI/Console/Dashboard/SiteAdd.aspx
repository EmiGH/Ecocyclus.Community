<%@ Page Title="" Language="C#" MasterPageFile="~/Console/Main.Master" AutoEventWireup="true"
    CodeBehind="SiteAdd.aspx.cs" Inherits="CSI.WebUI.Console.Dashboard.SiteAdd" %>
...
<asp:Content ID="cntSiteAdd" ContentPlaceHolderID="cphContent" runat="server">
            ...
            $("#<%=txtClient.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        data: "{'clientPattern':'" + $('#<%=txtClient.ClientID%>').val() + "'}",
                        dataType: "json",
            ...
            $("#<%=txtAgent.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        data: "{'agentPattern':'" + $('#<%=txtAgent.ClientID%>').val() + "'}",
                        dataType: "json",
                        success: function (data) {
                            response(data.d);
                        },
            ...
            $("#<%=txtContractor.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        data: "{'contractorPattern':'" + $('#<%=txtContractor.ClientID%>').val() + "'}",
                        dataType: "json",
                        success: function (data) {
                            response(data.d);
                        },
            ...
            $("#<%=txtResponsible.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        data: "{'responsiblePattern':'" + $('#<%=txtResponsible.ClientID%>').val() + "'}",
                        dataType: "json",
                        success: function (data) {
                            response(data.d);
                        },
            ...
            $("#<%=txtManager.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        ...
                        data: "{'managerPattern':'" + $('#<%=txtManager.ClientID%>').val() + "'}",
                        dataType: "json",
                        success: function (data) {
                            response(data.d);
                        },
    ...
    <div class="divForm AddSite">
        
        <div class="divLineSeparatorHeader AddSite"></div>
        ...
        <div id="divImage" class="divColumn column3 img">
            ...
            <span class="file-wrapper">
                ...
                <asp:Label ID="lblChoosePicture" runat="server" CssClass="button" UseSubmitBehavior="false"></asp:Label>
            </span>
            <div class="clear">
            </div>
        </div>
        <div class="divColumn column1p last">
            ...
            <asp:RequiredFieldValidator ID="rfvTitle" runat="server" ValidationGroup="Add" ControlToValidate="txtTitle"
        ...
        <div class="divColumn column1p last">
            ...
            <asp:CompareValidator ID="cvTypes" runat="server" ControlToValidate="ddlTypes"
                        Operator="NotEqual" ValueToCompare="0" ValidationGroup="Add" Display="Dynamic"
        ...
        <div class="divColumn column1 text">
            ...
            <asp:RegularExpressionValidator ID="revLogo" runat="server" ValidationExpression="^.*\.(jpg|JPG|gif|GIF|png|PNG|bmp|BMP)$"
                ControlToValidate="fuImage" ValidationGroup="Add"></asp:RegularExpressionValidator>
        </div>
           <div class="clear">
            </div>
        <div class="divColumn column3">
            ...
            <asp:CustomValidator ID="cvStart" runat="server" ValidationGroup="Add" EnableClientScript="true"
            ...
            <asp:TextBox ID="txtStart" ReadOnly="true" runat="server" CssClass="lblValue"></asp:TextBox>
        ...
        <div class="divColumn column3 text margin   ">
            ...
            <asp:RequiredFieldValidator ID="rfvValue" ValidationGroup="Add" EnableClientScript="true"
            ...
            <asp:RequiredFieldValidator ID="rfvCurrencies" runat="server" ControlToValidate="ddlCurrencies"
                ValidationGroup="Add" EnableClientScript="true"></asp:RequiredFieldValidator>
        </div>
        <div class="divColumn column3">
            <!-- FloorSpace -->
            <asp:Label ID="lblFloorSpace" runat="server" CssClass="lblTitle"></asp:Label>
            <asp:RequiredFieldValidator ID="rfvFloorSpace" ValidationGroup="Add" EnableClientScript="true"
        ...
        <div class="divColumn column3">
            ...
            <asp:RegularExpressionValidator ID="revUrl" runat="server" ValidationGroup="Add"
        ...
        <div class="divColumn column1 multiLine margin">
            ...
            <asp:Button ID="btnDescriptionTranslations" runat="server" OnClientClick="toggleDescriptionTranslations();return false;"
                CssClass="btnActions" UseSubmitBehavior="false" />
        ...
        <div class="divColumn column3 text margin">
            ...
            <asp:Label ID="lblIsPublic" runat="server" CssClass="lblTitle checkbox"></asp:Label>
        </div>
        <div class="clear"></div>
        <div class="divTitle">
        ...
        <div id="divMapPickup">
            <div id="divMapLocator" class="divColumn column1">
                ...
                <input type="text" class="lblValue" id="txtMapLocator" value="" />
            </div>
            <div class="clear">
            </div>
        ...
        <div class="divContentSave">
            <asp:Button ID="btnSave" runat="server" ValidationGroup="Add" UseSubmitBehavior="false"
                OnClientClick="setHiddenValues();"  CssClass="btnActions btnSave" />
        </div>
