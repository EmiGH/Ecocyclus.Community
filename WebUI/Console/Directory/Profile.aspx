<%@ Page Title="" Language="C#" MasterPageFile="~/Console/Main.Master" AutoEventWireup="true"
    CodeBehind="Profile.aspx.cs" Inherits="CSI.WebUI.Console.Directory.Profile" %>
    ...
    <div class="divDetail">
        <div class="divTitle">
            ...
            <div class="divActions">
                <asp:LinkButton ID="lnkEditProfile" runat="server" PostBackUrl="~/Console/Directory/ProfileEdit.aspx" CssClass="lnkModify"></asp:LinkButton>
