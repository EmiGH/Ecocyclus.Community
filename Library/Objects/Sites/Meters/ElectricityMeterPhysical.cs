...
namespace CSI.Library.Objects.Sites.Meters
{
    public class ElectricityMeterPhysical: ElectricityMeter
    {
        ...
        { get { 
            if(HasValue())
                return new Handlers.ElectricityMeters().LastReading(IdMeter);
            return _InitialReading;
