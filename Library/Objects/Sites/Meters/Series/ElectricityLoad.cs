...
namespace CSI.Library.Objects.Sites.Meters.Series
{
    public class ElectricityLoad
    {
        ...
        internal ElectricityLoad(Int64 idLoad, Int64 idMeter, Int64 idOperator, DateTime from, DateTime to, Double value, Double valueInput, Auxiliaries.Units.Unit unit, Double ef, Security.Credential credential)
        {
            _IdLoad = idLoad;
        ...
        internal ElectricityLoad(Int64 idLoad, Int64 idMeter, Users.UserOperator userOperator, DateTime from, DateTime to, Double value, Double valueInput, Auxiliaries.Units.Unit unit, Double ef, Security.Credential credential)
        {
            _IdLoad = idLoad;
