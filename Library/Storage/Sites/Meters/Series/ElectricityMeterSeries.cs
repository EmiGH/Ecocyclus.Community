...
namespace CSI.Library.Storage
{
    internal class ElectricityMeterSeries
    {
        ...
        internal Int64 Create(Int64 idLoad, DateTime day, Double value, Double valuePattern, Double totalCO2)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("SiteElectricityMeterSeries_Create");
            ...
            //Parámetro de salida
            _db.AddOutParameter(_dbCommand, "IdSiteElectricityMeterSerie", DbType.Int64, 18);

            //Ejecuta el comando
            _db.ExecuteNonQuery(_dbCommand);

            //Retorna el identificador
            return Convert.ToInt64(_db.GetParameterValue(_dbCommand, "IdSiteElectricityMeterSerie"));
        ...
        internal void Update(Int64 idLoad, Double value, Double valuePattern, Double totalCO2)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("SiteElectricityMeterSeries_Update");
            _db.AddInParameter(_dbCommand, "IdSiteElectricityMeterLoad", DbType.Int64, idLoad);
            _db.AddInParameter(_dbCommand, "Value", DbType.Double, value);
            _db.AddInParameter(_dbCommand, "ValuePattern", DbType.Double, valuePattern);
            _db.AddInParameter(_dbCommand, "TotalCO2", DbType.Double, totalCO2);
