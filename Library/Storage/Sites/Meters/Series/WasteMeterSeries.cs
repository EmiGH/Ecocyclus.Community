...
namespace CSI.Library.Storage
{
    internal class WasteMeterSeries
    {
        ...
        internal IEnumerable<DbDataRecord> ReadAll(Int64 idMeter, String idLanguage, DateTime from, DateTime to)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("SiteWasteMeterSeries_ReadAll");
        ...
        internal IEnumerable<DbDataRecord> ReadById(Int64 idSerie, String idLanguage, DateTime from, DateTime to)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("SiteWasteMeterSeries_ReadByID");
            _db.AddInParameter(_dbCommand, "IdSiteWasteMeterSerie", DbType.Int64, idSerie);
            if(from != DateTime.MinValue) _db.AddInParameter(_dbCommand, "DateFrom", DbType.Date, from);
            if (to != DateTime.MaxValue) _db.AddInParameter(_dbCommand, "DateTo", DbType.Date, to);
            _db.AddInParameter(_dbCommand, "IdLanguage", DbType.String, idLanguage);
        ...
        internal IEnumerable<DbDataRecord> ReadMagnitudes(Int64 idMeter)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("SiteWasteMeterSeries_ReadMagnitudes");
            _db.AddInParameter(_dbCommand, "IdSiteWasteMeter", DbType.Int64, idMeter);
        ...
        internal Int64 ReadMagnitude(Int64 idMeter)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("SiteWasteMeterSeries_ReadMagnitude");
            _db.AddInParameter(_dbCommand, "IdSiteWasteMeter", DbType.Int64, idMeter);
        ...
        internal Int64 Create(Int64 idMeter, DateTime date, Int64 idWasteType, Double value, Double valuePattern, Int64 idUnit, Double emissionFactorValue, Int64 idEmissionFactor, Double totalCO2, Int64 idOperator)
        {
            Database _db = DatabaseFactory.CreateDatabase();

            DbCommand _dbCommand = _db.GetStoredProcCommand("SiteWasteMeterSeries_Create");
            ...
            //Parámetro de salida
            _db.AddOutParameter(_dbCommand, "IdSiteWasteMeterSerie", DbType.Int64, 18);

            //Ejecuta el comando
            _db.ExecuteNonQuery(_dbCommand);

            //Retorna el identificador
            return Convert.ToInt64(_db.GetParameterValue(_dbCommand, "IdSiteWasteMeterSerie"));
        ...
        internal void Delete(Int64 IdSerie)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("SiteWasteMeterSeries_Delete");
            _db.AddInParameter(_dbCommand, "IdSiteWasteMeterSerie", DbType.Int64, IdSerie);
        ...
        internal void DeleteAll(Int64 IdMeter)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("SiteWasteMeterSeries_DeleteAll");
            _db.AddInParameter(_dbCommand, "IdSiteWasteMeter", DbType.Int64, IdMeter);

            //Ejecuta el comando
            _db.ExecuteNonQuery(_dbCommand);
        }
        internal void Update(Int64 IdSerie, DateTime date, Int64 idWasteType, Double value, Double valuePattern, Int64 idUnit, Double emissionFactorValue, Int64 idEmissionFactor, Double totalCO2, Int64 idOperator)
        {
            Database _db = DatabaseFactory.CreateDatabase();

            DbCommand _dbCommand = _db.GetStoredProcCommand("SiteWasteMeterSeries_Update");            
