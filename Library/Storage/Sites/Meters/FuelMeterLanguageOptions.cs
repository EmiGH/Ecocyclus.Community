...
namespace CSI.Library.Storage
{
    internal class FuelMeterLanguageOptions
    {
        ...
        internal IEnumerable<DbDataRecord> ReadAll(Int64 idMeter)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("SiteFuelMeterLanguageOptions_ReadAll");
        ...
        internal IEnumerable<DbDataRecord> ReadById(Int64 idMeter, String idLanguage)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("SiteFuelMeterLanguageOptions_ReadById");
            _db.AddInParameter(_dbCommand, "IdSiteFuelMeter", DbType.Int64, idMeter);
        ...
        internal void Create(Int64 idMeter, String idLanguage, String description)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("SiteFuelMeterLanguageOptions_Create");
            _db.AddInParameter(_dbCommand, "IdSiteFuelMeter", DbType.Int64, idMeter);
            _db.AddInParameter(_dbCommand, "IdLanguage", DbType.String, idLanguage);
        ...
        internal void Delete(Int64 idMeter, String idLanguage)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("SiteFuelMeterLanguageOptions_Delete");
            _db.AddInParameter(_dbCommand, "IdSiteFuelMeter", DbType.Int64, idMeter);
            _db.AddInParameter(_dbCommand, "IdLanguage", DbType.String, idLanguage);
        ...
        internal void DeleteAll(Int64 idMeter)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("SiteFuelMeterLanguageOptions_DeleteAll");
            _db.AddInParameter(_dbCommand, "IdSiteFuelMeter", DbType.Int64, idMeter);
        ...
        internal void Update(Int64 idMeter, String idLanguage, String description)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("SiteFuelMeterLanguageOptions_Update");
            _db.AddInParameter(_dbCommand, "IdSiteFuelMeter", DbType.Int64, idMeter);
            _db.AddInParameter(_dbCommand, "IdLanguage", DbType.String, idLanguage);
            _db.AddInParameter(_dbCommand, "Description", DbType.String, description);
