...
namespace CSI.Library.Storage
{
    internal class TransportUnits
    {
        ...
        internal IEnumerable<DbDataRecord> ReadAll(String idLanguage)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("UnitsForTransport_ReadAll");
        ...
        internal IEnumerable<DbDataRecord> ReadAllByMagnitude(Int64 idMagnitude, String idLanguage)
        {
            ...
            DbCommand _dbCommand = _db.GetStoredProcCommand("UnitsForTransport_ReadAllByMagnitude");
