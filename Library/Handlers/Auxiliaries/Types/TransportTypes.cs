...
namespace CSI.Library.Handlers
{
    internal class TransportTypes
    {
        ...
        internal Dictionary<Int64, Library.Objects.Auxiliaries.Types.TransportType> Items(Security.Credential credential)
        {
            ...
            IEnumerable<System.Data.Common.DbDataRecord> _record = _dbTransportTypes.ReadAll(_idLanguage);
