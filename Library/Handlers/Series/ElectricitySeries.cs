...
namespace CSI.Library.Handlers
{
    internal class ElectricitySeries
    {
        ...
        internal Objects.Auxiliaries.Units.Unit ReadMeterElectricityUnit(Int64 idMeter, Security.Credential credential)
        {
            return new Units().Item(new Storage.ElectricitySeries().ReadUnitForMeter(idMeter), credential);
        }
        ...
        internal Objects.Auxiliaries.Units.Unit ReadSiteElectricityUnit(Int64 idSite, Security.Credential credential)
        {
            return new Units().Item(new Storage.ElectricitySeries().ReadUnitForSite(idSite), credential);
        }
        ...
        internal Objects.Auxiliaries.Units.Unit ReadCompanyElectricityUnit(Int64 idCompany, Security.Credential credential)
        {
            return new Units().Item(new Storage.ElectricitySeries().ReadUnitForCompany(idCompany), credential);
        }
